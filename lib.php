 ...
 * @copyright  2025 Oscar Valverde http://moodle.agendanos.com
...
///// Turnitin Class ////////////////////////////////////////////////////
class plagiarism_plugin_cloud_bucket extends plagiarism_plugin {
     /**
    ...
    */
    ...
    public function print_disclosure($cmid) {
        ...
        echo format_text($plagiarismsettings['cloud_bucket_student_disclosure'], FORMAT_MOODLE, $formatoptions);
        echo $OUTPUT->box_end();
    }
...
function cloud_bucket_event_file_uploaded($eventdata) {
    $result = true;
        //a file has been uploaded - submit this to the plagiarism prevention service.

    return $result;
}
function cloud_bucket_event_files_done($eventdata) {
    $result = true;
...
function cloud_bucket_event_mod_created($eventdata) {
    $result = true;
...
function cloud_bucket_event_mod_updated($eventdata) {
    $result = true;
...
function cloud_bucket_event_mod_deleted($eventdata) {
    $result = true;
